...
deepspeed llava/train/train_mem.py \
    ...
    --version v1 \
    --data_path /orcd/data/faez/001/annie/llava/finetune_data/pythonocc_train_data.json \
    ...
    --bf16 True \
    --output_dir /orcd/data/faez/001/annie/llava/checkpoints/llava-v1.5-13b-4gpu-pythonocc \
    --num_train_epochs 1 \
