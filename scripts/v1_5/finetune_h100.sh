...
deepspeed llava/train/train_mem.py \
    ...
    --version v1 \
    --data_path /orcd/data/faez/001/annie/llava/finetune_data/llava_v1_5_mix665k.json \
    ...
    --bf16 True \
    --output_dir /orcd/data/faez/001/annie/llava/checkpoints/llava-v1.5-13b-4gpu \
    --num_train_epochs 1 \
